            ...
            try:
                ...
                if use_reranker:
                    ...
                    if should_prevent_doc_processing_rerank:
                        ...
                        # Note: Threshold check will still be done using reranker scores (reranker does filtering too)
                    else:
                ...
                if context_docs:
                    ...
                    system_prompt = (
                        ...
                        "Sen lise düzeyindeki öğrencilere ders konularını öğreten deneyimli bir eğitim asistanısın. "
                        "Görevin, sağlanan BAĞLAM metnini kullanarak öğrencilerin sorularına TÜRKÇE, anlaşılır ve eğitici cevaplar vermektir.\n\n"
                        ...
                        "3. Kendi genel bilgini kullanma, SADECE bağlamdaki bilgileri kullan\n"
                        ...
                        "5. SADECE NİHAİ CEVABI YAZ - analiz sürecini, adımları, düşünceleri, kontrol listelerini gösterme\n"
                        "6. Lise öğrencisi seviyesine uygun, sade ve anlaşılır bir dil kullan\n"
                        "7. Gerektiğinde günlük hayattan örnekler ver ama sadece bağlamdaki bilgilerle sınırlı kal\n\n"
                        "💡 ÖRNEKLER:\n"
                        "- Bağlamda 'azot %78' yazıyorsa kesinlikle %78 yaz, başka değer yazma\n"
                        "- Bağlamda sorunun cevabı yoksa SADECE 'Bu bilgi ders dökümanlarında bulunamamıştır.' yaz, başka hiçbir şey ekleme\n"
                        "- Teknik terimler kullanırken lise öğrencisinin anlayabileceği şekilde açıkla"
                    )
